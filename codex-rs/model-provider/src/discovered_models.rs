...
//!
//! The shipped catalog is a good description of the models Codex knows how to
...
///
/// Not the first-party OpenAI path: that catalog is already served by the Codex
...
/// speech, image models) that Codex cannot drive.
///
