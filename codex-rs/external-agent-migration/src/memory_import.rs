...
- Keep source-specific frontmatter in the imported resource. Do not reinterpret fields such as `metadata.originSessionId` as a Ore `thread_id`, `rollout_path`, or `updated_at`.
