//! Omits checklist-tool guidance from Ore-owned prompts, before adding caller text.

/// Call only for Ore-owned prompt text; custom instructions must remain unchanged.
