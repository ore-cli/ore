...
/// The easiest way to iterate is to add unit tests and have ore fix the implementation.
...
/// Tests are at the top to encourage using TDD + ore to fix the implementation.
mod tests {
    use super::*;
