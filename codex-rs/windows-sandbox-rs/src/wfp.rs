...
const SESSION_NAME: &str = "Ore Windows Sandbox WFP";
const PROVIDER_NAME: &str = "Ore Windows Sandbox WFP";
const PROVIDER_DESCRIPTION: &str = "Persistent WFP provider for Ore Windows sandbox filters";
const SUBLAYER_NAME: &str = "Ore Windows Sandbox WFP";
const SUBLAYER_DESCRIPTION: &str = "Persistent WFP sublayer for Ore Windows sandbox filters";

// WFP identifies persistent providers, sublayers, and filters by stable GUIDs.
// These values are Ore-owned identities; do not regenerate them unless we
...
/// Installs the persistent Ore WFP filters for `account`.
///
...
/// Ensures the persistent Ore WFP provider exists.
...
/// Ensures the persistent Ore sublayer exists under the Ore provider.
