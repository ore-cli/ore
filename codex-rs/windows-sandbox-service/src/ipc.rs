...
fn handle_request(
    ...
    if let Err(error) = policy_result {
        ...
        crate::service::log_error(
            ...
            &format!("Ore sandbox provisioning was rejected by administrator policy: {error}"),
        );
        return Err(error)
    ...
    match run_elevated_provisioning_setup_with_retained_handles(
        ...
        Ok(()) => {
            ...
            crate::service::log_information(
                ...
                "Ore sandbox provisioning completed successfully.",
            );
        ...
        Err(error) => {
            crate::service::log_error(
                ...
                &format!("Ore sandbox provisioning failed: {error}"),
            );
