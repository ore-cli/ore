...
//! "leave the old title alone" or "clear the title Ore last wrote".
...
pub(crate) enum SetTerminalTitleResult {
    ...
    /// the title Ore manages, or some other fallback.
    NoVisibleContent,
}
...
/// or a previous program may have set before Ore started managing the title.
