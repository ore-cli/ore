...
impl HistoryCell for UpdateAvailableHistoryCell {
    fn display_lines(&self, width: u16) -> Vec<Line<'static>> {
        ...
        let update_instruction = if let Some(update_action) = self.update_action {
            ...
            line![
                "See ",
                "https://github.com/ore-cli/ore".cyan().underlined(),
        ...
        let content = text![
            ...
            "https://github.com/ore-cli/ore/releases/latest"
                .cyan()
                .underlined(),
        ];
    ...
    fn raw_lines(&self) -> Vec<Line<'static>> {
        let update_instruction = if let Some(update_action) = self.update_action {
            ...
            "See https://github.com/ore-cli/ore for installation options.".to_string()
        };
        vec![
            ...
            Line::from("https://github.com/ore-cli/ore/releases/latest"),
        ]
    }
...
pub(crate) fn new_server_version_warning(
    ...
    if notice.offer_update {
        ...
        lines.push(Line::from("  ore app-server daemon update".cyan()));
