...
const TEST_CURATED_PLUGINS_COORDINATES: &str = "openai/plugins";

fn test_curated_repo() -> CuratedPluginsRepo {
    parse_curated_plugins_repo(TEST_CURATED_PLUGINS_COORDINATES)
        .expect("test coordinates should parse")
}
