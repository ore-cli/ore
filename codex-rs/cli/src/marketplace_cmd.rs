...
#[derive(Debug, Parser)]
#[command(bin_name = "ore plugin marketplace")]
...
enum MarketplaceSubcommand {
    ...
    /// List plugin marketplaces Ore is currently considering and their roots.
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "ore plugin marketplace add",
    after_help = "Examples:\n  ore plugin marketplace add ./path/to/marketplace\n  ore plugin marketplace add owner/repo --ref main\n  ore plugin marketplace add https://github.com/owner/repo --sparse plugins/foo"
)]
...
#[derive(Debug, Parser)]
#[command(bin_name = "ore plugin marketplace list")]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "ore plugin marketplace upgrade",
    after_help = "Examples:\n  ore plugin marketplace upgrade\n  ore plugin marketplace upgrade debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "ore plugin marketplace remove",
    after_help = "Example:\n  ore plugin marketplace remove debug"
)]
