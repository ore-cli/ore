...
#[derive(Debug, Parser)]
#[command(
    bin_name = "ore plugin add",
    after_help = "Examples:\n  ore plugin add sample@debug\n  ore plugin add sample --marketplace debug"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "ore plugin list",
    after_help = "Examples:\n  ore plugin list\n  ore plugin list --marketplace debug\n  ore plugin list --json\n  ore plugin list --available --json"
)]
...
#[derive(Debug, Parser)]
#[command(
    bin_name = "ore plugin remove",
    after_help = "Examples:\n  ore plugin remove sample@debug\n  ore plugin remove sample --marketplace debug"
)]
