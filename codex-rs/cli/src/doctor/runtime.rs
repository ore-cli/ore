//! Captures how this ore process was launched.
//!
...
/// Builds the process provenance row for the current ore executable.
///
...
pub(super) fn search_check() -> DoctorCheck {
    ...
    if status != CheckStatus::Ok {
        check = check.remediation("Install ripgrep or repair the bundled ore package.");
    }
    check
}
