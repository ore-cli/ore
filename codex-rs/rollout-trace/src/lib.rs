//! Trace bundle format, writer, and reducer for ore rollouts.
//!
//! This crate owns the trace schema. Hot-path ore code should depend on the
...
/// Shared recorder context for inference attempts within one ore turn.
...
/// Request data for the canonical ore tool boundary.
...
/// Append-only writer used by hot-path ore instrumentation.
